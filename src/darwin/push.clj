(ns darwin.push
  ...
  (:require [darwin.push.literals :refer :all])
...
(defn interpret-one-step
  ...
  (let [v (peek-stack push-state :exec)
    ...
    (cond
      ...
      (symbol? v) ((coalesce
                    (ns-resolve 'darwin.push.literals v)
                    (ns-resolve 'darwin.push.instructions v))
                   popped) ;; v is a symbol pointing to a function
